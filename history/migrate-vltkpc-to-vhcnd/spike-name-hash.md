...
- `history/migrate-vltkpc-to-vhcnd/CONTEXT.md`
- `history/migrate-vltkpc-to-vhcnd/approach.md`
- `history/migrate-vltkpc-to-vhcnd/feasibility-matrix.md`
- `history/migrate-vltkpc-to-vhcnd/spike-scripts/fnv1a-probe-summary.json`
- `history/migrate-vltkpc-to-vhcnd/spike-scripts/fnv1a-probe-evidence.md`
- `history/migrate-vltkpc-to-vhcnd/spike-scripts/audit-dryrun-summary.json`
- `history/migrate-vltkpc-to-vhcnd/spike-scripts/audit-dryrun-evidence.md`
- `history/migrate-vltkpc-to-vhcnd/spike-scripts/e1-acceptance-evidence.md`
...
- Zero `/var/www/vltkunity` refs were returned under `/var/www/vhcnd` in the E_M1 acceptance check.
...
python3 scripts/vltk-audit-equipment-stat-coverage.py \
  ...
  --out /var/www/vltk-h5-survivors/harness-experimental/history/migrate-vltkpc-to-vhcnd/spike-scripts/outputs/equipment-stat-coverage.audit.json \
...
> Rerouting `--vltkpc-root` to `/var/www/vhcnd/sources` fails because catalog `source.path` values are `Client/Settings/item/*.txt`, but vhcnd does not expose those files under `/var/www/vhcnd/sources/Client/Settings/item/`. All 1,231 source line checks are `source-file-unreadable`.
...
- E_M1 isolation is acceptable: vhcnd no longer depends on `/var/www/vltkunity`, and the required SPR scan baseline remains `335/10/325`.

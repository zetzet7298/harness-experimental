...
#   E2R_NOTE="..." bash history/migrate-vltkpc-to-vhcnd/spike-scripts/e2r-run-on-approval.sh
...
python3 history/migrate-vltkpc-to-vhcnd/spike-scripts/e2r-approve-and-finalize.py \
...
echo "  - history/migrate-vltkpc-to-vhcnd/spike-scripts/e2r-approve-and-finalize-report.json"
echo "  - history/migrate-vltkpc-to-vhcnd/spike-scripts/e2r-go-no-go.json"
echo "  - history/migrate-vltkpc-to-vhcnd/spike-scripts/e2r-operator-pulse.json"

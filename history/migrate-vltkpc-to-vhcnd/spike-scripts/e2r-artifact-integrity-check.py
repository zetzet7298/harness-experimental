...
root_bundle = Path('history/migrate-vltkpc-to-vhcnd/e2r-operator-evidence-bundle.md')
...
lines.append(f"| `history/migrate-vltkpc-to-vhcnd/e2r-operator-evidence-bundle.md` | {'✅' if bundle_exists else '❌'} |")
if missing:

...
Source spec: `history/migrate-vhcnd-to-vhcnd/current-work.md` E_M1 "Move steps"
Pre-flight ref: `history/migrate-vhcnd-to-vhcnd/spike-scripts/preflight-evidence.md` (mig-q6k)

## Re-verify (Check 3) immediately before mv

```
$ rg -l '/var/www/vhcnd' /var/www/vhcnd | sort
...
- `/var/www/vhcnd/other-game/download-source/` ✓ (exists but EMPTY — `data_cdn_spr_img` ghost confirmed)
...
```
$ mv /var/www/vhcnd/item_spr /var/www/vhcnd/item_spr
exit=0
...
```
$ mv /var/www/vhcnd/item_spr_img /var/www/vhcnd/item_spr_img
exit=0
...
```
$ mv /var/www/vhcnd/other-game/item_spr_like_img /var/www/vhcnd/other-game/item_spr_like_img
exit=0
...
`/var/www/vhcnd/other-game/download-source/` exists in vltkunity but
...
| 5 | `ls /var/www/vhcnd/item_spr` returns "No such file or directory" | PASS |
| 5 | `ls /var/www/vhcnd/item_spr_img` returns "No such file or directory" | PASS |
| 5 | `ls /var/www/vhcnd/other-game/item_spr_like_img` returns "No such file or directory" | PASS |

```
$ ls /var/www/vhcnd/item_spr 2>&1
ls: cannot access '/var/www/vhcnd/item_spr': No such file or directory
$ ls /var/www/vhcnd/item_spr_img 2>&1
ls: cannot access '/var/www/vhcnd/item_spr_img': No such file or directory
$ ls /var/www/vhcnd/other-game/item_spr_like_img 2>&1
ls: cannot access '/var/www/vhcnd/other-game/item_spr_like_img': No such file or directory
```

...
## Operator command
- Dry-run: `python3 history/migrate-vhcnd-to-vhcnd/spike-scripts/e2r-golditem-apply-repair-proposals.py`
- Apply: `python3 history/migrate-vhcnd-to-vhcnd/spike-scripts/e2r-golditem-apply-repair-proposals.py --apply`

- Apply + verify: `python3 history/migrate-vhcnd-to-vhcnd/spike-scripts/e2r-golditem-apply-repair-proposals.py --apply --verify`

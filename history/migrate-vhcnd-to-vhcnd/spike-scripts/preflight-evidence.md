...
Source spec: `history/migrate-vhcnd-to-vhcnd/current-work.md` E_M1 section

## Check 1 — Filesystem identity (same mount required for `mv`)

```
$ stat -c '%m %n' /var/www/vhcnd /var/www/vhcnd
/ /var/www/vhcnd
/ /var/www/vhcnd
```
...
```
$ rg -l '/var/www/vhcnd' /var/www/vhcnd --max-count 1 \
...
$ python3 /var/www/vhcnd/tools/scan_required_spr.py \
    ...
    --spr-root  /var/www/vhcnd/item_spr \
...
sprRoot   : /var/www/vhcnd/item_spr

...
| `US-010` | `Ba Lăng huyện` map/minimap and mobile enemy templates are ported from VLTKPC evidence; NPCs and immobile templates are excluded and minimap has no NPC names | passed: `python3 tests/test_vltk_porting_smoke.py` | passed: `python3 scripts/vltk-port-map.py`, `npm run typecheck`, `npm run build` | passed: headless Chrome map/enemy screenshots | local browser | implemented | `docs/stories/epics/E03-vltkpc-asset-porting/US-010-port-balang-huyen-map.md`; `docs/validation/2026-05-18-balang-huyen-map-port.md`; `game-source/data/vltk-normalized/maps/balang-huyen.port.json`; `game-source/src/data/maps.json`; `game-source/artifacts/screenshots/2026-05-18-balang-huyen-enemies.png`; `game-source/artifacts/screenshots/2026-05-18-balang-huyen-regionc-background-linear-12s.png` |

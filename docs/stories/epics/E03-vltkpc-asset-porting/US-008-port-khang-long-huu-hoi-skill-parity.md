...
Port Cái Bang `Kháng Long Hữu Hối` from active VLTKPC data into the H5 runtime with evidence-backed skill identity, level-20 spread behavior, copied local SPR/SFX assets, generated runtime sheets, and validation artifacts.
...
- Source SPR/SFX files are copied under `game-source/public/assets/skills/vltkpc/source/skill-khang-long-huu-hoi/` before runtime composition.

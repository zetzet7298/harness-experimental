...
H5 prototype must port Cái Bang skill `Bổng Đả ác Cẩu` from VLTKPC into the current auto-fire loop with verified skill identity (`SkillId=125`, `MissleId=47`), level-20 cast profile, and preview-gated visual+SFX parity artifacts before claiming 100% match.

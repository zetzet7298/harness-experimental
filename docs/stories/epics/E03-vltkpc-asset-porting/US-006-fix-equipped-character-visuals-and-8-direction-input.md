...
The H5 prototype must render the known mounted VLTKPC loadout with `Tu La phát kết`, `Giáng Sa bào`, `Phiên Vũ`, and `Địch Khái Trúc Trượng`, using copied local SPR sources, preview-gated runtime composition, 8-direction mounted-run animation, mounted-idle standing visuals, and touch-anywhere joystick movement.
...
- Runtime assets remain under `game-source/public/assets/character/vltkpc/` and never load from `/var/www/vltkpc`.
...
- `game-source/public/assets/character/vltkpc/equipped-tu-la-giang-sa-staff-phien-vu-run.json`
- `game-source/public/assets/character/vltkpc/equipped-tu-la-giang-sa-staff-phien-vu-idle.json`

...
- Normalize VHCND normal/gold equipment tables into a generated H5 catalog.
...
- None, but source-backed VHCND evidence and runtime-local asset rules apply.
...
- A formula cannot be traced to VHCND source and would require guessing.
- Runtime visual assets would need direct reads from `/var/www/vhcnd`.

...
Validated the H5 runtime change for the known VLTKPC mounted loadout:
...
- Runtime metadata: `game-source/public/assets/character/vltkpc/equipped-tu-la-giang-sa-staff-phien-vu-run.json`
- Idle runtime metadata: `game-source/public/assets/character/vltkpc/equipped-tu-la-giang-sa-staff-phien-vu-idle.json`
...
- Runtime still loads only copied repo-local assets under `game-source/public/assets/character/vltkpc/`.

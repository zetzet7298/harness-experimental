...
- Treat `/var/www/vltkpc` as legacy source evidence and `/var/www/vltk-h5-survivors/game-source` as the only H5 runtime/edit target.
- Do not make the H5 app read `/var/www/vltkpc` at runtime; copy/extract assets into `game-source` first.
...
- Mark any user-requested deviation as `explicit override`, never as VLTKPC parity.
...
python3 /var/www/vltk-h5-survivors/harness-experimental/.codex/skills/vltk-item-research/scripts/vltk_extract_tables.py \
  --client-dir /var/www/vltkpc/extracted_build_jxwin_soucgoc_hoiquanvolam/source_from_vmdk/SourceNew/swrod3/bin/Client \
  --source-root /var/www/vltkpc/extracted_build_jxwin_soucgoc_hoiquanvolam/source_from_vmdk/SourceNew/swrod3 \
...
- Runtime assets: `/var/www/vltk-h5-survivors/game-source/public/assets/skills/vltkpc/`
...
VLTKPC missile hit visuals are status-specific. Do not treat hit sound or projectile vanish as a complete collision port. Before wiring any skill that can collide with an enemy:
